...
export default function Home() {
  return (
      <main className="flex flex-col-reverse lg:flex-row min-h-screen">
        <div
            className="relative lg:w-1/2 p-10"
        >
          <video
              autoPlay
              muted
              loop
              className="absolute z-0 inset-0 object-cover w-full bg-transparent h-screen"
          >
            <source src="../Video/landingpage1p.mp4" type="video/mp4"/>
          </video>
          <div className="relative flex flex-col justify-center h-full">
            ...
            <p className="text-lg my-6 mx-auto text-center text-white">
             A Fun Way to Chat with People
            </p>
            <p className="text-sm opacity-90 mx-auto text-center text-white">
              Join ChatMate today and connect with others.
            </p>
            <a
                href="https://github.com/Prabhatgrg/ChatMate"
